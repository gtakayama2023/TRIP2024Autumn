...
Double_t Brho_NMR[8];
//===== TS in CCNET01 ===========================
unsigned long long camac_ts0[2][2];
unsigned long long camac_ts[2];
Int_t ccnet08_data[6];
//===== TS in MPV04 ===========================
unsigned int mpv_Nevent[1];
unsigned long long mpv_ts0[1][2];
unsigned long long  mpv_ts[1];
//Double_t mpv_ts[1];
//Double_t mpv_10kclock[1];
unsigned int  mpv_10kclock[1];
//===== V1190 =================================
// [32]: Channel
// [10]: 1st/2nd/.../10th-hit event
long long v1190[32][N_Mhit];
long long v1190raw[32][N_Mhit];
Int_t v1190num[32];
//===== Default DAQ ===========================
//===== Others ================================
// [9] : No of CC/NET
