...
double  Inoffset[12][4][2]={
  ...
  // 1.37, -0.21, // 2A X/Y
  //  1.20, -0.27, // 2B X/Y
  0.87, -1.13, // 1A X/Y //after 14:30 2024-05-16
  0.42, -0.65, // 1B X/Y //after 14:30 2024-05-16
  0.84, -0.75, // 2A X/Y //after 14:30 2024-05-16
  0.78, -1.09, // 2B X/Y //after 14:30 2024-05-16
  // F4	               
  0.95, 0.17, // 1A X/Y
  0.00, 0.00, // 1B X/Y
  0.00, 0.00, // 2A X/Y
...
double  ns2mm[12][4][2]={
  ...
  // 1.241,-1.237,	// 2A X/Y
  //  1.236,-1.232,	// 2B X/Y
  1.244,-1.235,// 1A X/Y//after 14:30 2024-05-16
  1.244,-1.221,// 1B X/Y//after 14:30 2024-05-16
  1.214,-1.229,// 2A X/Y//after 14:30 2024-05-16
  1.222,-1.211,// 2B X/Y//after 14:30 2024-05-16
  // F4		         
  1.242, 1.223,	// 1A X/Y
  1.000, 1.000,	// 1B X/Y
  1.000, 1.000,	// 2A X/Y
...
double ch2MeV_IC[2][4][6]={
  ...
  0.00639, 0.00639, 0.0000, 0.00639, 0.00639, 0.00639,
  // F8MUSIC
  //  0.0149, 0.0149, 0.0149, 0.0000, 0.0000, 0.0000,
  0.00788, 0.00788, 0.00788, 0.0000, 0.0000, 0.0000,
  // F11MUSIC
  //  1.,1.,1.,1.,1.,1.,
  0.01500, 0.01500, 0.01500, 0.01500, 0.01500, 0.01500,
  // F3MUSIC
  1.,1.,1.,1.,1.,1.,
  // pedestal
  // F7MUSIC
  //  +19.441,+19.441,+19.441,+19.441,+19.441,+19.441,
  +16.490,+16.490,+0.000,+16.490,+16.490,+16.490,
  // F8MUSIC
  //  -74.890,-74.890,-74.890,0.,0.,0.,
  +285.812, +285.812, +285.812,0.,0.,0.,
  // F11MUSIC
  //  0.,0.,0.,0.,0.,0.,
  95.713, 95.713, 95.713, 95.713, 95.713, 95.713,
  // F3MUSIC
  0.,0.,0.,0.,0.,0.,
};
//===== Transfer Matrix =======================
