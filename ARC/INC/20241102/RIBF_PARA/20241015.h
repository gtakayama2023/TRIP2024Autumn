...
double Tsum_Offset[2][12][4]={
  // X
   ...
   98.8,  95.9, 169.4, 179.3, // F3 (55Catune0213)
    0.0,   0.0,   0.0,   0.0, // F4
  175.7, 174.4, 173.3, 178.9, // F5
    0.0,   0.0,   0.0,   0.0, // F6
  168.7, 175.3,  87.6,  97.3, // F7
  179.3, 177.6, 177.3, 183.3, // F8
...
double Tsum_Min[2][12][4]={
  // X
   ...
   -30.0,-30.0,    50,    50, /* F07 1A/1B/2A/2B */
...
double ch2MeV_IC[2][4][6]={
  ...
  // F3MUSIC
  0.015644,0.015644,0.015644,0.015644,0.015644,0.015644,
  // pedestal
  // F7MUSIC
...
//===== F7Ge ==============================
// [2]  : 0 = slope (keV/ch) | 1 = pedestal (ch, pedestal(keV)/slope(k\
eV/ch))
double ch2keV_F7Ge[8][2] = {
  0.4212, -10.57/0.4212,
  0.3675, -11.27/0.3675,
  0.4162, -12.14/0.4162,
  0.3890, -14.34/0.3890,
