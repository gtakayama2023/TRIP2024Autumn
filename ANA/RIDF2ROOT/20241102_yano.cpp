...
void ridf2root(int runN=48, TString runname="56Co", bool tree_output=0, int loadEvt = 10000 /* 0 = NO, 1 = Yes */){
  ...
  */
  ...
  TH2D *hraw_v1290L;
  hraw_v1290L = new TH2D("hraw_v1290L_0",Form("V1290L (PLA-T) rawdata | run%04d;ID;T (ns)"          ,runN),32,0,32,1000,0,25000);
  TH2D *hraw_v1290Lnum;
  hraw_v1290Lnum = new TH2D("hraw_v1290Lnum_0",Form("V1290 (PLA-T) Multiplicity | run%04d;ID;#it{N}_{hit}"          ,runN),32,0,32,10,0,10);
  TH2D *hraw_v1290Lnum2;
  hraw_v1290Lnum2 = new TH2D("hraw_v1290Lnum2_0",Form("V1290 (PLA-T) Multiplicity2 | run%04d;ID;#it{N}_{hit}"          ,runN),32,0,32,10,0,10);
  ...
  TH2D *hraw_PLA_v1290;
  hraw_PLA_v1290 = new TH2D("hraw_PLA_v1290_T"  ,Form("PLA-T   V1290raw | run%04d;F03/F05/F07/F08/F09/F11/F8VETO/F11Long/F3-2/F5-2/F7-2;V1290raw (ch)",runN),22,0,22,500,400e3,600e3);
  ...
  */
  ...
  cPPAC->Divide(3, 3);
  for(int j=0;j<6;j++){
    cPPAC->cd(j+1); hcalib_Fpl_XY[j]->Draw("APE");
    cPPAC->cd(j+4); hcalib_Fpl_XA[j]->Draw("APE");
    cPPAC->cd(j+7); hcalib_Fpl_YB[j]->Draw("APE");
  }
