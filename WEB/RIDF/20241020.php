...
if (($handle = fopen($csvFile, 'r')) !== false) {
    ...
    echo "<p><a href='/cgi-bin/$base_url/EXP/RIBF/TRIP/2024/AUTUMN/USR/default/RIDF/csvruninfo.pl' style='color: #4CAF50; text-decoration: none;'>Update runsummary</a></p>";
    ...
    while (($data = fgetcsv($handle, 1000, ',', '"')) !== false) {
        ...
        echo "<td><a href='/cgi-bin/$base_url/EXP/RIBF/TRIP/2024/AUTUMN/USR/$subDir/ridf2root?runNo=$runNumber&runName=" . urlencode($runName) . "' target='_blank'>ridf2root</a></td>";

        // JSROOT URLを次の列に追加
        echo "<td><a href='/cgi-bin/$base_url/EXP/RIBF/TRIP/2024/AUTUMN/USR/$subDir/WEB/JSR/jsroot.pl?runNo=$runNumber&runName=" . urlencode($runName) . "' target='_blank'>HIST</a>, <a href='/cgi-bin/$base_url/EXP/RIBF/TRIP/2024/AUTUMN/USR/$subDir/WEB/JSR/jsroot.pl?hist_or_tree=ROOT&runNo=$runNumber&runName=" . urlencode($runName) . "' target='_blank'>TREE</a></td>";
